  ...
  private ${sub.paramData.className}Service ${sub.paramData.lowerName}Service;
	...
	public void list(@ModelAttribute ${className}Entity query,HttpServletRequest request,HttpServletResponse response,
			...
			try {
			 	...
			 	PageQuery<${className}Entity> pageQuery = new PageQuery<${className}Entity>();
				...
				String viewName = "${projectName}<#if bussPackage ? exists>/${bussPackage}</#if>/${lowerName}-list.vm";
	...
	public void ${lowerName}Detail(@RequestParam(required = true, value = "id" ) String id,HttpServletResponse response,HttpServletRequest request)throws Exception{
			VelocityContext velocityContext = new VelocityContext();
			String viewName = "${projectName}<#if bussPackage ? exists>/${bussPackage}</#if>/${lowerName}-detail.vm";
	...
	public void toAddDialog(HttpServletRequest request,HttpServletResponse response)throws Exception{
		 VelocityContext velocityContext = new VelocityContext();
		 String viewName = "${projectName}<#if bussPackage ? exists>/${bussPackage}</#if>/${lowerName}-add.vm";
		 ViewVelocity.view(request,response,viewName,velocityContext);
	}
	...
	public void toEdit(@RequestParam(required = true, value = "id" ) String id,HttpServletResponse response,HttpServletRequest request) throws Exception{
			 ...
			 String viewName = "${projectName}<#if bussPackage ? exists>/${bussPackage}</#if>/${lowerName}-edit.vm";
			 ViewVelocity.view(request,response,viewName,velocityContext);
	}
